(function() {
    ...
    14: [function(require, module, exports) {
        ...
        function querystring(e) {
            for (var r, n = /([^=?&]+)=?([^&]*)/g, t = {}; r = n.exec(e); t[decode(r[1])] = decode(r[2]));
            return t
        }

        function querystringify(e, r) {
            r = r || "";
            var n = [];
            for (var t in "string" != typeof r && (r = "?"), e) has.call(e, t) && n.push(encodeURIComponent(t) + "=" + encodeURIComponent(e[t]));
    ...
    27: [function(require, module, exports) {
        ...
        "./info-ajax": 24,
        "./info-iframe": 26,
        "./transport/sender/xdr": 49,
        "./transport/sender/xhr-cors": 50,
        "./transport/sender/xhr-fake": 51,
        "./transport/sender/xhr-local": 52,
        "./utils/url": 67,
        "_process": 13,
        "debug": 3,
    ...
    29: [function(require, module, exports) {
        (function(process, global) {
            ...
            "production" !== process.env.NODE_ENV && (debug = require("debug")("sockjs-client:main")), inherits(SockJS, EventTarget), SockJS.prototype.close = function(t, e) {
                ...
                debug("_transportTimeout"), this.readyState === SockJS.CONNECTING && this._transportClose(2007, "Transport timed out")
        ...
        "./event/close": 17,
        "./event/event": 19,
        "./event/eventtarget": 20,
        "./event/trans-message": 21,
        "./iframe-bootstrap": 23,
        "./info-receiver": 27,
        "./location": 28,
        "./shims": 30,
    ...
    31: [function(require, module, exports) {
        ...
        "./transport/eventsource": 35,
        "./transport/htmlfile": 36,
        "./transport/jsonp-polling": 38,
        "./transport/lib/iframe-wrap": 41,
        "./transport/websocket": 53,
        "./transport/xdr-polling": 54,
        "./transport/xdr-streaming": 55,
        "./transport/xhr-polling": 56,
        "./transport/xhr-streaming": 57
    }],
    32: [function(require, module, exports) {
        (function(process, global) {
            ...
            function AbstractXHRObject(t, e, r, i) {
                debug(t, e);
                var s = this;
                EventEmitter.call(this), setTimeout(function() {
                    s._start(t, e, r, i)
            ...
            "production" !== process.env.NODE_ENV && (debug = require("debug")("sockjs-client:browser:xhr")), inherits(AbstractXHRObject, EventEmitter), AbstractXHRObject.prototype._start = function(t, e, r, i) {
                var s = this;
                try {
                    this.xhr = new XHR
                } catch (t) {}
                ...
                if (i && i.noCredentials || !AbstractXHRObject.supportsCORS || (debug("withCredentials"), this.xhr.withCredentials = "true"), i && i.headers)
                    for (var n in i.headers) this.xhr.setRequestHeader(n, i.headers[n]);
                this.xhr.onreadystatechange = function() {
                    if (s.xhr) {
                        var t, e, r = s.xhr;
                        switch (debug("readyState", r.readyState), r.readyState) {
                            case 3:
                                try {
                                    e = r.status, t = r.responseText
                                } catch (t) {}
                                debug("status", e), 1223 === e && (e = 204), 200 === e && t && t.length > 0 && (debug("chunk"), s.emit("chunk", e, t));
                                break;
                            case 4:
                                e = r.status, debug("status", e), 1223 === e && (e = 204), 12005 !== e && 12029 !== e || (e = 0), debug("finish", e, r.responseText), s.emit("finish", e, r.responseText), s._cleanup(!1)
                        }
                    }
                };
                try {
    ...
    69: [function(require, module, exports) {
        (function(global) {
            ...
            function lolcation(e) {
                var o, t = {},
                    s = typeof(e = e || global.location || {});
                if ("blob:" === e.protocol) t = new URL(unescape(e.pathname), {});
                else if ("string" === s)
                    for (o in t = new URL(e, {}), ignore) delete t[o];
                else if ("object" === s) {
                    for (o in e) o in ignore || (t[o] = e[o]);
                    void 0 === t.slashes && (t.slashes = slashes.test(e.href))
                }
                return t
            }
            ...
            function URL(e, o, t) {
                ...
                var s, r, a, n, l, i, h = rules.slice(),
                    c = typeof o,
                    p = this,
                    u = 0;
                for ("object" !== c && "string" !== c && (t = o, o = null), t && "function" != typeof t && (t = qs.parse), o = lolcation(o), s = !(r = extractProtocol(e || "")).protocol && !r.slashes, p.slashes = r.slashes || s && o.slashes, p.protocol = r.protocol || o.protocol || "", e = r.rest, r.slashes || (h[2] = [/(.*)/, "pathname"]); u < h.length; u++) a = (n = h[u])[0], i = n[1], a != a ? p[i] = e : "string" == typeof a ? ~(l = e.indexOf(a)) && ("number" == typeof n[2] ? (p[i] = e.slice(0, l), e = e.slice(l + n[2])) : (p[i] = e.slice(l), e = e.slice(0, l))) : (l = a.exec(e)) && (p[i] = l[1], e = e.slice(0, l.index)), p[i] = p[i] || s && n[3] && o[i] || "", n[4] && (p[i] = p[i].toLowerCase());
                t && (p.query = t(p.query)), s && o.slashes && "/" !== p.pathname.charAt(0) && ("" !== p.pathname || "" !== o.pathname) && (p.pathname = resolve(p.pathname, o.pathname)), required(p.port, p.protocol) || (p.host = p.hostname, p.port = ""), p.username = p.password = "", p.auth && (n = p.auth.split(":"), p.username = n[0] || "", p.password = n[1] || ""), p.origin = p.protocol && p.host && "file:" !== p.protocol ? p.protocol + "//" + p.host : "null", p.href = p.toString()
            }
            ...
            function set(e, o, t) {
                ...
                switch (e) {
                    case "query":
                        "string" == typeof o && o.length && (o = (t || qs.parse)(o)), s[e] = o;
                        break;
                    case "port":
                        s[e] = o, required(o, s.protocol) ? o && (s.host = s.hostname + ":" + o) : (s.host = s.hostname, s[e] = "");
                        break;
                    case "hostname":
                        s[e] = o, s.port && (o += ":" + s.port), s.host = o;
                        break;
                    case "host":
                        s[e] = o, /:\d+$/.test(o) ? (o = o.split(":"), s.port = o.pop(), s.hostname = o.join(":")) : (s.hostname = o, s.port = "");
                        break;
                    case "protocol":
            ...
            function toString(e) {
                ...
                var r = s + (t.slashes ? "//" : "");
                return t.username && (r += t.username, t.password && (r += ":" + t.password), r += "@"), r += t.host + t.pathname, (o = "object" == typeof t.query ? e(t.query) : t.query) && (r += "?" !== o.charAt(0) ? "?" + o : o), t.hash && (r += t.hash), r
            }
            URL.prototype = {
                set: set,
                toString: toString
    ...
    71: [function(require, module, exports) {
        ...
        function Scaledrone(e, t) {
            ...
            t = assign({}, {
                ...
                if (-1 === ["observable_members", "observable_member_join", "observable_member_leave"].indexOf(t.type)) {
                    ...
                    var g = r.rooms[t.room];
                    if (!g) return;
                    var d = t.type.slice("observable_".length);
                    g.trigger(d, t.data)
                }
        ...
        }, isBrowser ? window.ScaleDrone = window.Scaledrone = Scaledrone : module.exports = Scaledrone;
    ...
    72: [function(require, module, exports) {
        ...
        function Room(e, t, s) {
            ...
            this.name = e, this._history = {
                messages: [],
                nextIndex: 0
            }, this._historyCount = r, this._historyReceivedCount = 0, this.scaledrone = s, this._observable = isObservable(e), this._observable && (this._cache = [], this.on("members", function(e) {
        ...
        Events.mixin(Room.prototype), Room.prototype.unsubscribe = function() {
            ...
            for (var t = 0; t < this._cache.length; t++) {
                var s = this._cache[t];
                if (s.id === e) return s
            }
            return null
        }, Room.prototype._trigger = function(e, t) {
            hasListeners(this, e) ? this.trigger(e, t) : t && this.scaledrone.trigger("error", t)
            ...
            this._history.messages[e.index] = e, this._history.messages[this._history.nextIndex] && function e() {
                var s = t._history.messages[t._history.nextIndex];
                t._history.nextIndex++;
                var i = s.message,
                    r = s.client_id,
                    n = {
                        data: i,
                ...
                r && (n.clientId = r), t.trigger("history_message", n), t._history.messages[t._history.nextIndex] && e()
            }()
        }, module.exports = Room;
